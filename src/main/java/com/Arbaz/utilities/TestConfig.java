package com.Arbaz.utilities;
public class TestConfig{


	
	public static String server="smtp.gmail.com";
	public static String from = "arbaztestingstudio@gmail.com";
	public static String password = "Keepaway#1";
	public static String[] to ={"arbaztestingstudio@gmail.com"};
